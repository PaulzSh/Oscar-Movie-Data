...
import com.citi.oscar.movie.entity.Role;
import com.citi.oscar.movie.entity.User;
import com.citi.oscar.movie.model.UserRegistration;
import com.citi.oscar.movie.repository.UserRepository;
...
public class UserServiceImpl implements UserService {
	...
	public User save(UserRegistration registration) {
		...
		var user = new User(registration.getFirstName(), registration.getLastName(), registration.getEmail(),
				passwordEncoder.encode(registration.getPassword()), Arrays.asList(new Role("ROLE_ADMIN")));
